...
if __name__ == '__main__':
	...
	original_test_set = "/home/kkuma12s/thesis/Proof_Extraction/data/fever-full/shared_dev_true_docs_evidences.jsonl"
	predicted_claims_set = "/scratch/kkuma12s/github/fact-validation/thesis-code/Proof_Extraction/data/fever-full/complete_pipeline/fever_full_test_elmo_with_evidences.jsonl"
	final_output = "/scratch/kkuma12s/github/fact-validation/thesis-code/Proof_Extraction/data/fever-full/complete_pipeline/fever_full_test_elmo_final_output.jsonl"
	...
	# predicted_claims_set = "/home/kkuma12s/thesis/Proof_Extraction/data/fever-full/fever_blind_set/claim_classifier/fever_blind_elmo_unique_ids.jsonl"
	# final_output = "/home/kkuma12s/thesis/Proof_Extraction/data/fever-full/fever_blind_set/final_output/predictions_elmo.jsonl"
