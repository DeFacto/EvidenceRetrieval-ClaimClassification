...
class TestPipeline:
	...
	def compute_score(self, dataset):
		...
		file_ = open("elmo_complete_results.txt", mode="w")
		...
		file_.write("\n")
		print ("score of elmo ",  precision_recall_fscore_support(true_labels, pred_labels, average='weighted'))
...
if __name__ == '__main__':
	...
	combine_results_path = "/scratch/kkuma12s/github/fact-validation/thesis-code/Proof_Extraction/data/fever-full/complete_pipeline/claim_cls/fever_full_test_elmo_combined_results_with_evidences.jsonl"
	
	testPipeline = TestPipeline(cc_results_path)

	testPipeline.combine_results(combine_results_path)

	final_results_path = "/scratch/kkuma12s/github/fact-validation/thesis-code/Proof_Extraction/data/fever-full/complete_pipeline/fever_full_test_elmo_with_evidences.jsonl"
